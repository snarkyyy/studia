...
Program
  : ListFnDef { (fst $1, Latte.Abs.Program (fst $1) (snd $1)) }

FnDef :: { (Latte.Abs.BNFC'Position, Latte.Abs.FnDef) }
FnDef
  : Type Ident '(' ListArg ')' Block { (fst $1, Latte.Abs.FnDef (fst $1) (snd $1) (snd $2) (snd $4) (snd $6)) }

ListFnDef :: { (Latte.Abs.BNFC'Position, [Latte.Abs.FnDef]) }
ListFnDef
  : FnDef { (fst $1, (:[]) (snd $1)) }
...
Arg
  : Type '&' Ident { (fst $1, Latte.Abs.ArgRef (fst $1) (snd $1) (snd $3)) }
...
Stmt
  ...
  | 'if' '(' Expr ')' Block { (uncurry Latte.Abs.BNFC'Position (tokenLineCol $1), Latte.Abs.Cond (uncurry Latte.Abs.BNFC'Position (tokenLineCol $1)) (snd $3) (snd $5)) }
  | 'if' '(' Expr ')' Block 'else' Block { (uncurry Latte.Abs.BNFC'Position (tokenLineCol $1), Latte.Abs.CondElse (uncurry Latte.Abs.BNFC'Position (tokenLineCol $1)) (snd $3) (snd $5) (snd $7)) }
  | 'while' '(' Expr ')' Block { (uncurry Latte.Abs.BNFC'Position (tokenLineCol $1), Latte.Abs.While (uncurry Latte.Abs.BNFC'Position (tokenLineCol $1)) (snd $3) (snd $5)) }
  | Expr ';' { (fst $1, Latte.Abs.SExp (fst $1) (snd $1)) }
  | 'break' ';' { (uncurry Latte.Abs.BNFC'Position (tokenLineCol $1), Latte.Abs.Break (uncurry Latte.Abs.BNFC'Position (tokenLineCol $1))) }
  | 'continue' ';' { (uncurry Latte.Abs.BNFC'Position (tokenLineCol $1), Latte.Abs.Continue (uncurry Latte.Abs.BNFC'Position (tokenLineCol $1))) }
  | FnDef { (fst $1, Latte.Abs.InnerFnDef (fst $1) (snd $1)) }
...
ArgType :: { (Latte.Abs.BNFC'Position, Latte.Abs.ArgType) }
ArgType
  : Type { (fst $1, Latte.Abs.ArgType (fst $1) (snd $1)) }
  | Type '&' { (fst $1, Latte.Abs.ArgTypeRef (fst $1) (snd $1)) }

ListArgType :: { (Latte.Abs.BNFC'Position, [Latte.Abs.ArgType]) }
ListArgType
  : {- empty -} { (Latte.Abs.BNFC'NoPosition, []) }
  | ArgType { (fst $1, (:[]) (snd $1)) }
