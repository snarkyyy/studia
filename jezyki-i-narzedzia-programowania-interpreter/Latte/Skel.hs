...
transProgram x = case x of
  Latte.Abs.Program _ fndefs -> failure x

transFnDef :: Show a => Latte.Abs.FnDef' a -> Result
transFnDef x = case x of
  Latte.Abs.FnDef _ type_ ident args block -> failure x

transArg :: Show a => Latte.Abs.Arg' a -> Result
transArg x = case x of
  Latte.Abs.ArgRef _ type_ ident -> failure x
...
transStmt x = case x of
  ...
  Latte.Abs.Cond _ expr block -> failure x
  Latte.Abs.CondElse _ expr block1 block2 -> failure x
  Latte.Abs.While _ expr block -> failure x
  Latte.Abs.SExp _ expr -> failure x
  Latte.Abs.Break _ -> failure x
  Latte.Abs.Continue _ -> failure x
  Latte.Abs.InnerFnDef _ fndef -> failure x
...
transType x = case x of
  ...
  Latte.Abs.Fun _ type_ argtypes -> failure x

transArgType :: Show a => Latte.Abs.ArgType' a -> Result
transArgType x = case x of
  Latte.Abs.ArgType _ type_ -> failure x
  Latte.Abs.ArgTypeRef _ type_ -> failure x
