...
instance Print (Latte.Abs.Program' a) where
  prt i = \case
    Latte.Abs.Program _ fndefs -> prPrec i 0 (concatD [prt 0 fndefs])

instance Print (Latte.Abs.FnDef' a) where
  prt i = \case
...
instance Print (Latte.Abs.Arg' a) where
  prt i = \case
    Latte.Abs.ArgRef _ type_ id_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "&"), prt 0 id_])
...
instance Print (Latte.Abs.Stmt' a) where
  prt i = \case
    ...
    Latte.Abs.Cond _ expr block -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block])
    Latte.Abs.CondElse _ expr block1 block2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block1, doc (showString "else"), prt 0 block2])
    Latte.Abs.While _ expr block -> prPrec i 0 (concatD [doc (showString "while"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block])
    Latte.Abs.SExp _ expr -> prPrec i 0 (concatD [prt 0 expr, doc (showString ";")])
    Latte.Abs.Break _ -> prPrec i 0 (concatD [doc (showString "break"), doc (showString ";")])
    Latte.Abs.Continue _ -> prPrec i 0 (concatD [doc (showString "continue"), doc (showString ";")])
    Latte.Abs.InnerFnDef _ fndef -> prPrec i 0 (concatD [prt 0 fndef])
...
instance Print (Latte.Abs.Type' a) where
  prt i = \case
    ...
    Latte.Abs.Fun _ type_ argtypes -> prPrec i 0 (concatD [prt 0 type_, doc (showString "("), prt 0 argtypes, doc (showString ")")])

instance Print (Latte.Abs.ArgType' a) where
  prt i = \case
    Latte.Abs.ArgType _ type_ -> prPrec i 0 (concatD [prt 0 type_])
    Latte.Abs.ArgTypeRef _ type_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "&")])
