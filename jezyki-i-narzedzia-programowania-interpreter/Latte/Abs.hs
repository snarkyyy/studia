...
data Program' a = Program a [FnDef' a]
...
data Arg' a = ArgRef a (Type' a) Ident | Arg a (Type' a) Ident
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
data Type' a
  ...
  | Bool a
  | Void a
  | Fun a (Type' a) [ArgType' a]
  deriving (C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

instance C.Eq a => C.Eq (Type' a) where
  (==) (Int _) (Int _) = True
  (==) (Str _) (Str _) = True
  (==) (Bool _) (Bool _) = True
  (==) (Void _) (Void _) = True
  (==) (Fun _ ret1 arglist1) (Fun _ ret2 arglist2) = (ret1 == ret2) && (arglist1 == arglist2)
  (==) _ _ = False

type ArgType = ArgType' BNFC'Position

data ArgType' a = ArgType a (Type' a) | ArgTypeRef a (Type' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
